<main>
    ...
    <form class="text-center" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group mt-5">
                    ...
                    <input type="file" class="form-control" name="picture" id="picture" accept="image/jpeg, image/png, image/jpg">
                    <p><?= $errors['picture'] ?? '' ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="form-group mt-5">
            <label for="types">Catégorie du vehicule *</label>
        ...
        <p class="mt-4">* : signifie que les champs sont obligatoires</p>
        <div class="form-group mt-5">
